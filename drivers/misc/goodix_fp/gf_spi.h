...
#define HTC_TIME_TAG "[FP-TIME][GF_HTC_KERNEL_DEBUG]"
#endif //CONFIG_HTC_PCN_HAL_FOOTPRINT_CMD

#ifdef CONFIG_HTC_PCN_IRQ_ENABLE_LOG
#define HTC_DEBUG_TAG "[FP-DBG][GF_HTC_KERNEL_DEBUG]"
#endif //CONFIG_HTC_PCN_IRQ_ENABLE_LOG
...
#define GOODIX_FP_TAG           "[FP][Goodix] "
...
#ifdef CONFIG_HTC_PCN_HAL_FOOTPRINT_CMD
#define HTC_HAL_FOOTPRINT       _IOW(GF_IOC_MAGIC, 100, char)
#endif //CONFIG_HTC_PCN_HAL_FOOTPRINT_CMD
