...
/* HTC_START */
	...
	struct delayed_work work_temperature;
#endif
...
#ifdef CONFIG_NANOHUB_EDGE_ULTRA
	struct edge_ultra_cfg_data edge_ultra_cfg;
#endif
#endif
#ifdef CONFIG_NANOHUB_EDGE_MONITOR_CONTROL
	struct egm_cfg_data egm_cfg;
#endif
	...
	struct nanohub_bypass_notifier *bypass_notifier;
#endif
#ifdef CONFIG_NANOHUB_FLASH_GPIO_CONTROL
	int flash_gpio_control;
#endif
	uint8_t drop_buf_flag;
/* HTC_END */
};
