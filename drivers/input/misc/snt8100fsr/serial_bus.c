...
int sb_get_boot_status(struct snt8100fsr *snt8100fsr) {
    switch (snt8100fsr->bus_type) {
        case BUS_TYPE_SPI:
            return snt_spi_get_boot_status(snt8100fsr->spi);
        case BUS_TYPE_I2C:
            return snt_i2c_get_boot_status(snt8100fsr);
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            return snt_nanohub_get_boot_status(snt8100fsr);
#endif
...
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            return snt_nanohub_wake_device(snt8100fsr);
#endif
...
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            ret = snt_nanohub_write(snt8100fsr, num_write, data_out);
            if (ret) {
                PRINT_CRIT("snt_nanohub_write() failed");
                return -1;
            }
	break;
#endif
...
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            return snt_nanohub_read_fifo(snt8100fsr, reg, 2, (uint8_t *)in_val);
#endif
...
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            return snt_nanohub_write_fifo(snt8100fsr, reg, 2, (uint8_t *)out_val);
#endif
...
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            return snt_nanohub_read_fifo(snt8100fsr, reg, len, in_val);
#endif
...
#ifdef CONFIG_HTC_FEATURE
        case BUS_TYPE_NANOHUB:
            return snt_nanohub_write_fifo(snt8100fsr, reg, len, out_val);
#endif
