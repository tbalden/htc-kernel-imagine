...
struct stmvl53l0_data *g_vl53l0_data = NULL;
...
#endif
// HTC ADD //
static void __init stmvl53l0_probe_async(void *unused, async_cookie_t cookie)
{
    int rc = 0;
    struct stmvl53l0_data *vl53l0_data = g_vl53l0_data;
    struct i2c_data *i2c_object = (struct i2c_data *)vl53l0_data->client_object;

#ifdef HTC
    if (vl53l0_data->sensor_dev->of_node) {
        Laser_parse_dt(vl53l0_data->sensor_dev, vl53l0_data);
    }
#endif
    /* setup bus type */
    ...
    /* setup regulator */
    stmvl53l0_parse_vdd(vl53l0_data->sensor_dev, i2c_object);

    /* setup device name */
    vl53l0_data->dev_name = dev_name(vl53l0_data->sensor_dev);

    /* setup device data */
    dev_set_drvdata(vl53l0_data->sensor_dev, vl53l0_data);
