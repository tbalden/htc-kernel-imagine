...
enum cam_actuator_packet_opcodes {
	...
	CAM_ACTUATOR_PACKET_GYRO_GAIN // HTC_ADD
};

enum cam_eeprom_packet_opcodes {
	CAM_EEPROM_PACKET_OPCODE_INIT,
	CAM_EEPROM_PACKET_OPCODE_WRITE // HTC_ADD
};

enum cam_ois_packet_opcodes {
	CAM_OIS_PACKET_OPCODE_INIT,
	CAM_OIS_PACKET_OPCODE_OIS_CONTROL,
	CAM_OIS_PACKET_OPCODE_OIS_CALIBRATION, // HTC_ADD
	CAM_OIS_PACKET_OPCODE_OIS_READ_START, //HTC_ADD
	CAM_OIS_PACKET_OPCODE_OIS_READ_END, //HTC_ADD
	CAM_OIS_PACKET_OPCODE_OIS_GET_DATA //HTC_ADD
};
