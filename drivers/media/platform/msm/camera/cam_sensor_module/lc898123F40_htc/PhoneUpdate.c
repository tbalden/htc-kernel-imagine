...
//#include	"FromCode.h"
#if MODULE_VENDOR == 5 && MDL_VER == 8
 #include	"FromCode_05_05_08.h"
#else
 #include	"FromCode_05_05_08.h"
#endif
...
//HTC_START
UINT_8			module_version = 1;
//HTC_END

const DOWNLOAD_TBL DTbl[] = {
#if MODULE_VENDOR == 5 && MDL_VER == 8
	{0x0508, CcMagicCodeF40_05_05_08, sizeof(CcMagicCodeF40_05_05_08), CcFromCodeF40_05_05_08, sizeof(CcFromCodeF40_05_05_08) },
#else
	{0x0508, CcMagicCodeF40_05_05_08, sizeof(CcMagicCodeF40_05_05_08), CcFromCodeF40_05_05_08, sizeof(CcFromCodeF40_05_05_08) },
#endif
...
void F40_FlashSectorRead_htc_IME( UINT_32 UlAddress, UINT_8 *PucData, UINT_32 version )
{
	UINT_8	UcIndex, UcNum ;
	UINT_8	UcReadDat[ 4 ] ;
	...
	for( UcIndex = 0 ; UcIndex < UcNum ; UcIndex++ )
	{
		RamWrite32A( 0xF01B , UlAddress ) ;
		RamRead32A(  0xF01B , UcReadDat ) ;
		if(UlAddress == 0x1A02 && UcReadDat[ 2 ] == 0x31)
		{
			module_version = 0;
		}
		if(UlAddress >= 0x1BD9) //Workaround for P1 PDAF calibration data reverse
		{
			if(module_version == 0)
			{
				*PucData++	= UcReadDat[ 3 ] ;
