...
{
/* HTC_START */
	// Initialize local variable to avoid uninitialization error Klocwork issue.
	// The initial value 0 refers to cam_jpeg_mgr_hw_flush() and errno-base.h definition.
	int rc = 0;
/* HTC_END */
	int32_t ctx_id = 0;
	struct cam_jpeg_hw_mgr *hw_mgr = hw_mgr_priv;
