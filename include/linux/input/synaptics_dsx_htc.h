...
struct synaptics_dsx_board_data {
	...
	const char *touch_image_name[MAX_PANEL_NUM];
	...
	uint16_t eg_blk_permille;
	uint8_t support_glove;
	uint8_t glove_cmd_num;
	uint8_t lcm_reset_seq;
	uint8_t sensor_sleep_mode;
	uint8_t panel_id_num;
	uint8_t panel_id_array[MAX_PANEL_NUM];
	uint8_t support_eg_blk;
	uint8_t eg_blk_min_width;
#endif
