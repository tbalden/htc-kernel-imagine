...
#define FSA_SWITCH_GPIO_COUNT 3
/* HTC_AUD_END */
...
struct htc_headset_config {
	...
	void (*set_ext_micbias) (bool, short);
	...
	unsigned int fsa_switch_gpio[FSA_SWITCH_GPIO_COUNT];
	unsigned int fsa_switch_type;
	bool swap_detect;
};
/* HTC_AUD_END */
...
/* HTC_AUD_START */
	void (*htc_button_detection)(struct wcd_mbhc *mbhc, bool enable);
/* HTC_AUD_END */
};
